...
local discipline_priest = enums.class_spec_id.get_spec_id_from_enum(enums.class_spec_id.spec_enum.HOLY_PALADIN)

if player_spec_id ~= holy_paladin then
    plugin["load"] = true
    return plugin
end
